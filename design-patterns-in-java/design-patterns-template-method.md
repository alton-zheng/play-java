...
![模板方法设计模式](https://refactoringguru.cn/images/patterns/content/template-method/template-method.png?id=eee9461742f832814f19)
...
![数据挖掘类包含许多重复代码](https://refactoringguru.cn/images/patterns/diagrams/template-method/problem.png?id=60fa4f735c467ac1c943)
...
![模板方法定义了算法的框架](https://refactoringguru.cn/images/patterns/diagrams/template-method/solution-zh.png?id=413e3df47812a28320e0)
...
![建造大型房屋](https://refactoringguru.cn/images/patterns/diagrams/template-method/live-example.png?id=2485d52852f87da06c9c)
...
![模板方法设计模式的结构](https://refactoringguru.cn/images/patterns/diagrams/template-method/structure.png?id=924692f994bff6578d84)
...
![模板方法模式示例的结构](https://refactoringguru.cn/images/patterns/diagrams/template-method/example.png?id=c0ce5cc8070925a1cd34)
