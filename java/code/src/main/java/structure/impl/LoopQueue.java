...
/**
 * @Author: alton
 * @Date: Created in 2021/3/3 9:16 下午
 * @Description: 循环队列
 */
public class LoopQueue<E> implements Queue<E> {
    ...
    public LoopQueue(int numElements) {
...
/*    private void doubleCapacity() {
     ...
     * 获取首个元素
     * @return E 返回首个元素
     * @throws NoSuchElementException {@inheritDoc} 当返回元素等于 null 时，抛出此异常
     */
    public E getFirst() {
     ...
     * 获取最后一个元素
     * @return 返回最后一个元素
     * @throws NoSuchElementException {@inheritDoc} 当最后一个元素为空时，抛出此异常
     */
    public E getLast() {
     ...
     *
     * @return the head of the queue represented by this LoopQueue, or
     *         {@code null} if this deque is empty
     */
    public E poll() {
        return pollFirst();
    ...
    /**
     * Returns {@code true} if this LoopQueue contains no elements.
     *
     * @return {@code true} if this LoopQueue contains no elements
     */
    ...
    public Iterator<E> iterator() {
        return new LoopQueue.DeqIterator();
    }

    public Iterator<E> descendingIterator() {
        return new LoopQueue.DescendingIterator();
    }
     ...
     */
    public LoopQueue<E> clone() {
        try {
            @SuppressWarnings("unchecked")
            LoopQueue<E> result = (LoopQueue<E>) super.clone();
